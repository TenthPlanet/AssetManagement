...
{
    public class PCRepository : GenericRepository<AssetManagementEntities, Asset, PCBox>, IPCRepository
    {

        public PCBox FindAsset(string assetNumber)
        {
            return Context.PCBoxes.FirstOrDefault(x => x.assetNumber == assetNumber);
        }
        ...
        public override void Insert(AssetManagement.Domain.Entities.Asset entity, AssetManagement.Domain.Entities.PCBox dependent)
        {
            entity.catergory = "Tower";
