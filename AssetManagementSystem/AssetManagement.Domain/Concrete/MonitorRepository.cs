...
{
    public class MonitorRepository : GenericRepository<AssetManagementEntities, Asset, Monitor>, IMonitorRepository
    {
        public Monitor FindAsset(string assetNumber)
        {
            return Context.Monitors.FirstOrDefault(x => x.assetNumber == assetNumber);
        }
        ...
        public override void Insert(Asset entity, Monitor dependent)
        {
            entity.catergory = "Monitor";
