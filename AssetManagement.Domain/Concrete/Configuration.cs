    ...
    internal sealed class Configuration : DbMigrationsConfiguration<AssetManagement.Domain.Context.AssetManagementEntities>
    {
        ...
        protected override void Seed(AssetManagement.Domain.Context.AssetManagementEntities context)
        {
            context.Departments.AddOrUpdate(
                new Department { departmentName = "IT", departmentID = 1 },
                new Department { departmentName = "Accounting", departmentID = 2 },
                new Department { departmentName = "Human Resource", departmentID = 3 },
                new Department { departmentName = "Marketing", departmentID = 4 },
                new Department { departmentName = "Health", departmentID = 5 }
                 );
